...
import (
	...
	"github.com/iamvibs/golang-projects/url-shortner/database"
	"github.com/iamvibs/golang-projects/url-shortner/helpers"
...
func ShortenURL(c *fiber.Ctx) error {
	...
	rawBody := c.Body()
	fmt.Println("Received Body:", string(rawBody))
	...
	if err == redis.Nil {
		...
		if valInt <= 0 {
			fmt.Println("Rate Limit Value:", valInt)
